...
For example, if you want to find the application logic about REALIZER control,
 then you can go to the REALIZER Blueprint in CCM/realizer.py instead of scrolling through a big app.py (in this specific case
...
import logging
import json
from CCM.REALIZER import services
