...
# # logger.setLevel(CCM.app.config["LOG_LEVEL"])   # not working here
...
def publish_to_kafka_topic(topic_name, data_dict):
    ...
    # kafka_admin_client = KafkaAdminClient(bootstrap_servers=CCM.app.config["KAFKA_BROKER_URLS"]
    #                                       ,client_id=CCM.app.config["ENGINE_ID"])
    #
    ...
    # print('CCM --another place ', dir(CCM))
