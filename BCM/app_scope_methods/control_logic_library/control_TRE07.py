...
'''
Author: Ankur Saxena
Objective : This module outlays the logic executed for the control TRE07.
Here we will have all the logic executed for the TRE07 control.

These are the methods called for TRE07 control , Now here the db_session and the app_context is already set at
...
def method_tre07_4(appln_cntxt, db_session, mongo_client, control_params_dict):
    ...
    # this will get the database from the URI string
        ...
        mongo_pipeline_code_str = list_of_mongo_statements.AG_PIPELINE_TRE07_1_4
...
def method_tre07_4_5(appln_cntxt, db_session, mongo_client, control_params_dict):
    ''' This method is used to work as Stage 4.5th for the control.
     Processing Logic for the Auto reopen block '''
    ...
    # this will get the database from the URI string
        ...
        mongo_pipeline_code_str = list_of_mongo_statements.AG_PIPELINE_TRE07_1_4_5
