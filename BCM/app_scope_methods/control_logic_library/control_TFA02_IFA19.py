...
def method_tfa02_ifa19_3(appln_cntxt, db_session, mongo_client, control_params_dict):
    ...
    # this will get the database from the URI string
        ...
        mongo_pipeline_code_str = list_of_mongo_statements.AG_PIPELINE_TFA02_IFA19_1_3
...
def method_tfa02_ifa19_4(appln_cntxt, db_session, mongo_client, control_params_dict):
    ''' This method is used to work as Stage 4 for the control.
     Processing Logic for the marked records , which are S2A compliant. '''
    ...
    # this will get the database from the URI string
        ...
        mongo_pipeline_code_str = list_of_mongo_statements.AG_PIPELINE_TFA02_IFA19_1_4
...
def method_tfa02_ifa19_4_5(appln_cntxt, db_session, mongo_client, control_params_dict):
    ''' This method is used to work as Stage 4.5 th for the control.
     This inserts newer recs into the exception collection , which are NOT S2A. '''
    ...
    # this will get the database from the URI string
        ...
        mongo_pipeline_code_str = list_of_mongo_statements.AG_PIPELINE_TFA02_IFA19_1_4_5
...
def method_tfa02_ifa19_5(appln_cntxt, db_session, mongo_client, control_params_dict):
...
def method_tfa02_ifa19_6(appln_cntxt, db_session, mongo_client, control_params_dict):
...
def method_tfa02_ifa19_7(appln_cntxt, db_session, mongo_client, control_params_dict):
