#control_FIN08_AP_AR.py
'''
Author: Ankur Saxena
Objective : This module outlays the logic executed for the control FIN08_AP_AR.
Here we will have all the logic executed for the FIN08_AP_AR control.

These are the methods called for FIN08_AP_AR control , Now here the db_session and the app_context is already set at
...
def method_fin08_ap_ar_1(appln_cntxt, db_session, mongo_client, control_params_dict):
...
# def test_method_fin08_ap_ar(appln_cntxt, control_params_dict):
...
def method_fin08_ap_ar_3(appln_cntxt, db_session, mongo_client, control_params_dict):
...
def method_fin08_ap_ar_4(appln_cntxt, db_session, mongo_client, control_params_dict):
