...
'''
Author: Ankur Saxena
Objective : This module outlays the logic executed for the control FIN08_FA.
Here we will have all the logic executed for the FIN08_FA control.

These are the methods called for FIN08_FA control , Now here the db_session and the app_context is already set at
...
def method_fin08_fa_3(appln_cntxt, db_session, mongo_client, control_params_dict):
    ''' This method is used to work as Stage 3 for the control.
     ...
     For this control FIN08_FA; both the function_id and exception_collection_name are needed in this stage. '''
    ...
    # this will get the database from the URI string
        ...
        mongo_pipeline_code_str = list_of_mongo_statements.AG_PIPELINE_FIN08_FA_1_3
...
def method_fin08_fa_4(appln_cntxt, db_session, mongo_client, control_params_dict):
    ...
    # this will get the database from the URI string
        ...
        mongo_pipeline_code_str = list_of_mongo_statements.AG_PIPELINE_FIN08_FA_1_4     # Mongo statement for FIN08_FA control.
