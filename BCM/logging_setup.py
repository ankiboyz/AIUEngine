...
logging as per the APP (here it's BCM) , hence defining the way logs been set up per APP."""
...
def setup_logging(app):
    ...
    # with open('C:\\Users\\ASaxena\\PycharmProjects\\AIUEngine\\BCM\\log_cnfg.yaml', 'r') as f:
    # with open('.\\BCM\\log_cnfg.yaml', 'r') as f:
    # with open('./BCM/log_cnfg.yaml', 'r') as f:  This path separator (/ forward slash) works on Windows as well
